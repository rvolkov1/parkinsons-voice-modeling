...
#plot_learning_curve(clf, "learning_rate = 1.5", X, y, groups=groups, cv=cv, axes=axes[:, 0], train_sizes=train_sizes)
...
#figure.tight_layout()
#plt.savefig('../figures/GBoost_learning_rate_comparison.png')
#plt.show()
